<template>
  <div class="mainBox">
    <div class="aside-box">
      <div class="profile-intro" @click="topersion">
        <div style="position: relative;width: 48px;height: 48px;">
          <img :src="imgUrl" style="display: block;width: 48px;height: 48px;border-radius: 50%; cursor: pointer;" alt />
        </div>
        <div style="margin-left: 8px;width: 156px;position: relative;">
          ...
          <div style="display: flex;padding-top: 10px;justify-content: space-between;">
            <span style="width: 90px;line-height: 20px;font-size: 12px;color:#3399ea;line-height: 17px;cursor: pointer;">TA的个人主页</span>
          </div>
        </div>
      </div>
      <div class="flexBox">
    ...
    <div class="right">
      ...
      <div class="show-none" v-show="this.status==0">
        <div class="autop">
      ...
      <div class="show-up" v-show="this.status==1"   v-for="(item,index) in form" :key="index">
        ...
        <div class="article-info">
          <div class="item-left">
            ...
            <span>
              <i class="el-icon-view"></i>{{item.aRead}}
            </span>
            <span>
              <i class="el-icon-chat-line-square"></i>{{item.aComment}}
            </span>
          </div>
          <div class="btn">
            <a class="ap"><span style="padding: 0 8px;border-right: 1px solid#e9e9e9;" @click="view(index)" >查看</span></a>
            <div class="item-inline">
                <a class="ap"><span style="border-right: none;color: #ca0c16;padding: 0 8px;cursor: pointer;" @click="del(index)">删除</span></a>
            </div>
          </div>
        </div>
      </div>
